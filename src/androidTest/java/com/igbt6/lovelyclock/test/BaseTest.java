package com.igbt6.lovelyclock.test;
...
import com.igbt6.lovelyclock.persistance.AlarmDatabaseHelper;
...
class BaseTest {
    ...
    protected void assertTimerView(String s) {
        ...
        Cortado.onView().withId(com.igbt6.lovelyclock.R.id.hours_tens).check().matches(withText("" + s.charAt(0)));
        Cortado.onView().withId(com.igbt6.lovelyclock.R.id.hours_ones).check().matches(withText("" + s.charAt(1)));
        Cortado.onView().withId(com.igbt6.lovelyclock.R.id.minutes_tens).check().matches(withText("" + s.charAt(3)));
        Cortado.onView().withId(com.igbt6.lovelyclock.R.id.minutes_ones).check().matches(withText("" + s.charAt(4)));
    }
